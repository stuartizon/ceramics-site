...
- **Backend** (`apps/backend`): Medusa v2, Node/TypeScript. Admin dashboard for product/order management.
- **Storefront** (`apps/storefront`): Next.js 15, official Medusa storefront starter (cart, checkout, customer accounts, order history).
